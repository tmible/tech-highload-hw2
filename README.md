...
Mail Cloud Solutions. Основыные преимущества: единственный сервис, обещающий 1 Гбит/c исходящее соединение, дата-центры расположены в России. Остальные очевидны: репутация компании, гибкость конфигураций. Единственный потенциальный минус: используемые процессоры обрабатывают только 161 кадр в секунду при кодировке видео в H.624 [\[14\]][benchmark]. Нo, думаю, это решается запуском нужного количества потоков.
