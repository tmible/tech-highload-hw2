...
Подводя итог, на каждый звонок нужно иметь 17 потоков, 5 Гбайт оперативной памяти и 1 процессор, занятый перекодированием. По максимальному количеству звонков — 2 858 890 потоков, 840 850 Гбайт оперативной памяти и 168 170 процессоров, занятых перекодированием. Если принять, что процессоры в среднем имеют 100 потоков, на один процессор помещается 6 звонков. 6 звонкам требуется 30 Гбайт оперативной памяти.  

| Роль                                     | CPU | ОЗУ      | Жёсткий диск | Количество |
| ---------------------------------------- | --- | -------- | ------------ | ---------- |
| Балансировщик                            | 1   | 20 Гбайт | 480 Гбайт    | 1          |
| Сервис авторизации и управления звонками | 1   | 20 Гбайт | 480 Гбайт    | 1          |
| СУБД                                     | 1   | 6 Гбайт  | 480 Гбайт    | 1          |
| Хост звонков                             | 2   | 30 Гбайт | 480 Гбайт    | 14 015     |
| Перекодировщик                           | 8   | 10 Гбайт | 480 Гбайт    | 21 017     |

## Выбор хостинга / облачного провайдера и расположения серверов
Свои сервера чтобы иметь нужную пропускную способность сети.
